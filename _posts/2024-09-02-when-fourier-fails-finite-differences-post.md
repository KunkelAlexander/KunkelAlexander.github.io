...
$$\[\begin{bmatrix}1 & 0 & 0 \\1 & \frac{2}{dx} & 0 \\1 & \frac{2^2}{2! dx^2} & \frac{2^3}{3! dx^3}\end{bmatrix}\]\cdot\[
    \begin{bmatrix}f'(x_0) \\f''(x_0) \\f'''(x_0)\end{bmatrix}\] =\[\begin{bmatrix}f(x_1) - f(x_0) \\f(x_2) - f(x_0) \\f(x_3) - f(x_0)\end {bmatrix}\]$$
